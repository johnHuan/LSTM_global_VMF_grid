...
if __name__ == '__main__':
    base_dir = "/home/zhanghuan/dat01/ztd/VMF3_OP/period_model/"
    grid_data_path = base_dir + 'data/'
    dest_path = base_dir + 'residual/'
    files = os.listdir(grid_data_path)
    files.sort()
    try:
        for grid_file in files:
            lstm_vmf(grid_data_path, grid_file, dest_path, month=12, start_year=2008, end_year=2018)
